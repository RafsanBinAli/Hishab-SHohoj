...
router.put("/farmers/:id", farmerController.updateFarmerById);
router.get("/farmers/:id", farmerController.findFarmerById);
...
router.get(
  "/get-all-market-details-ofToday",
  newDealController.getAllMarketDealsOfToday
);
...
router.post(
  "/card-details-update-secondary",
  newDealController.updateCardDetails
);
router.get("/get-unpaid-deals", newDealController.getIncompleteMarketDeals);
router.get(
  "/get-deals-particular-day",
  newDealController.getDealsOfParticularDay
);
...
router.get("/shops/:id", shopController.getShopDetailsById);
